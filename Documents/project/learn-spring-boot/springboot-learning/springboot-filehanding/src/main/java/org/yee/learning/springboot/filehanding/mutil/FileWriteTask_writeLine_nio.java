...
public class FileWriteTask_writeLine_nio extends Thread {
    ...
    private void openWriteByteBuffer() {
        ...
        try {
            ...
            writerBuffer = writer.map(FileChannel.MapMode.READ_WRITE, 0, this.fileSplitter.getSubFileSizeLimit());
    ...
    public FileWriteTask_writeLine_nio(int taskSeq, FileSplitter fileSplitter, BlockingQueue<FileLine> queue) {

package org.yee.learning.springboot.filehanding.single.normal;
...
public class NormalPoolMaster extends Master {
    ...
    public NormalPoolMaster(String fileDir, String fileName, int subFileSizeLimit) {
        ...
        this.fileWritePool = new ThreadPoolExecutor(
                4,
                4,
                0L,
    ...
    public void execute() {
        ...
        try {
            ...
            while (reader.ready() && (lineContent = reader.readLine()) != null) {
                FileWriteTask fileWriteTask = this.getFileSplitter().split(lineContent);

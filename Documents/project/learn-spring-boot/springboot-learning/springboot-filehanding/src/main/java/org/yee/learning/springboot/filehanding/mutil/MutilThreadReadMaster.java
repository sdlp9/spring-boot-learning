...
public class MutilThreadReadMaster extends Master {
    ...
    @Override
    public void init() {
        //String orignFileFullName, int readTaskNum, int writeTaskNum, int maxLineSize, FileSplitter fileSpiltter
        taskAllocater = new TaskAllocater(Util.genFullFileName(this.getFileDir(), this.getFileName()), this.readTaskNum, this.writeTaskNum, 1024, this.getFileSplitter(), this.queue);
    }

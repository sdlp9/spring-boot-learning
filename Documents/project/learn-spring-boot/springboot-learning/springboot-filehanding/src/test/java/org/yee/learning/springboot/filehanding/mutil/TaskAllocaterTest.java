...
public class TaskAllocaterTest {
	...
	public void init() { 
		...
		FileSplitter fileSplitter = new FileSplitter(subFileSizeLimit, testDirRootPath, "test.csv");
		BlockingQueue queue = new LinkedBlockingQueue<FileLine>(1024);
		taskAllocater = new TaskAllocater(orignFileFullName, readTaskNum, writeTaskNum, maxLineSize, fileSplitter, queue);
	} 
